# this is for doing it locally ; make sure yr weavite is running in your docker before running this
...
def display_header_with_logo():
    ...
    logo_path = r"C:\Users\adity\Desktop\Gen-Ai Rag\local-system\critic.png"
...
client, embed_model = get_clients()
